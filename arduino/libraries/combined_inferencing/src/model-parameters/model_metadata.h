...
#define EI_CLASSIFIER_PROJECT_OWNER              "combined-local"
#define EI_CLASSIFIER_PROJECT_NAME               "voice-colour-motion-combined"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "audio + ch1 + ch2 + ch3 + ch4 + accX + accY + accZ"
